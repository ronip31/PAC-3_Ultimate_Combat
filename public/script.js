...
function mostraInfoJogador(jogadorId) {
    // Faz uma requisição ao servidor para obter as informações do jogador com base no ID
    fetch(`/api/obter_informacoes_jogador?id=${jogadorId}`)
        .then(response => response.json())
        .then(data => {
            // Atualiza os elementos HTML com as informações do jogador
            document.getElementById('nome').textContent = data.nome;
            document.getElementById('respeito').textContent = data.respeito;
            document.getElementById('estamina').textContent = data.estamina + '%';
            document.getElementById('inteligencia').textContent = data.inteligencia;
            document.getElementById('forca').textContent = data.forca;
            document.getElementById('carisma').textContent = data.carisma;
            document.getElementById('resistencia').textContent = data.resistencia;
            document.getElementById('grana').textContent = '$' + data.grana;
            // Atualize outros elementos aqui, se necessário.
        })
        .catch(error => {
